...
<v-btn
@click="insertToTaskphoto(taskDetail, taskLocation,taskLocationName,taskNum,taskStart1,taskStart2,taskStart3,taskStart4,taskTaotal1,taskTaotal2,taskTaotal3,taskTaotal4)"
        rounded
        color="primary"
        dark
      >
...
this.priceTotal = snapshot.val()[this.$route.params.key].typePhoto.price.price2
       let data = {
